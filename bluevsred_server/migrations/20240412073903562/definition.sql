...
--
-- Class BattleDb as table battle
--
CREATE TABLE "battle" (
...
--
-- Class GamePlayerDb as table player
--
CREATE TABLE "player" (
    "id" serial PRIMARY KEY,
    "name" text NOT NULL
...
--
-- Class BattleMapDb as table talle_map
--
